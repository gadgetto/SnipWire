...
$.fn.repeater = function (fig) {
    ...
    $(this).each(function () {
        ...
        var isSingleItemRequired = function () {
            if (fig.singleItemUndeletable && itemsCount() <= 1) {
                $list.find('[data-repeater-delete]').hide();
            } else {
                $list.find('[data-repeater-delete]').show();
            }
        };
